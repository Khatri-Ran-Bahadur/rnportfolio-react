...
return (
    <nav className="flex transition-transform duration-500 ease-in-out fixed w-full z-10 bg-bgColor h-18  px-10  justify-between items-center xs-mx:px-4 xs-mx:h-20">
        <IconHexagonLetterR className="z-10" size={isMobile?45:60} color="#64FFDA" stroke={1.25}/>
